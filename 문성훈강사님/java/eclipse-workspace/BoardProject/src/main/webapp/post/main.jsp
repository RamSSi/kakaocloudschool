...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
    import="java.util.ArrayList" import="post.vo.Post" import="member.vo.Member" %>
<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div> 안녕하세요. <%=member.getName() %> 님 </div>
	      ...
	      <div class="table-responsive">
	        <table class="table table-striped table-sm">
	          ...
	          %>
	            ...
	            <tr class="post" onClick="viewPost(<%= post.getNum() %>)">
	              <td><%= post.getNum()%></td>
	              <td><%= post.getTitle()%></td>
	              <td><%= post.getId()%></td>
	              <td><%= post.getDate()%></td>
	            ...
	            <script>
	              function viewPost(num) {
	            	window.location.href="/board/view?postNum=" + num;
	              }
	            </script>
	            <%
	          	}
